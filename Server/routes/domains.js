...
import { 
    getDomains, createDomain, subscribe, deleteDomain, getDomainById, user_subscribed_and_unsubscribed
...
router.get('/subscribed_and_unsubscribed',auth,user_subscribed_and_unsubscribed)
